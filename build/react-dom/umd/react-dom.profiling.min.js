(function (global, factory) {
  ...
  const ContentReset = /*                 */0b00000000000000000000100000;
  const Callback = /*                     */0b00000000000000000001000000;
  const DidCapture = /*                   */0b00000000000000000010000000;
  const ForceClientRender = /*            */0b00000000000000000100000000;
  const Ref = /*                          */0b00000000000000001000000000;
  const Snapshot = /*                     */0b00000000000000010000000000;
  const Passive = /*                      */0b00000000000000100000000000;
  const Hydrating = /*                    */0b00000000000001000000000000;
  const Visibility = /*                   */0b00000000000010000000000000;
  const StoreConsistency = /*             */0b00000000000100000000000000;
  const LifecycleEffectMask = Passive | Update | Callback | Ref | Snapshot | StoreConsistency;

  // Union of all commit flags (flags with the lifetime of a particular commit)
  const HostEffectMask = /*               */0b00000000000111111111111111;

  // These are not really side effects, but we still reuse this field.
  const Incomplete = /*                   */0b00000000001000000000000000;
  const ShouldCapture = /*                */0b00000000010000000000000000;
  const ForceUpdateForLegacySuspense = /* */0b00000000100000000000000000;
  const Forked = /*                       */0b00000100000000000000000000;
  ...
  const RefStatic = /*                    */0b00001000000000000000000000;
  ...
  const InvisibleParentSuspenseContext = 0b01;
